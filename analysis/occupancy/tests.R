...
print(paste("floral resourse site names matrix matches X matrix",
            all(dimnames(model.input$data$X)$site ==
                                            rownames(model.input$data$fra))))


print(paste("floral resourse year names matrix matches X matrix",
            all(dimnames(model.input$data$X)$year ==
