...
pdf.f(plotAllStatuses, file="figures/networks/spatial.pdf",
      height=6, width=4)

pdf.f(plotbyStatus, file="figures/networks/bystatus.pdf",
      height=6, width=8)

pdf.f(plotbySpecies, file="figures/networks/byspecies.pdf",
      height=6, width=6)
